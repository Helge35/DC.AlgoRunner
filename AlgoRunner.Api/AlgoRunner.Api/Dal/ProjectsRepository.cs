            ...
            _projects = new List<Project>
               {
                    ...
                    new Project{Id = 9, Name= "Project 9", LastExecutionDate= new DateTime(2018, 1,1), IsFavorite = true , CreatedBy="Big baga boss", ExecutionsList =new List<ProjectExecution>{
                            ...
                            AlgorithmsList = new List<Algorithm>{
                                    new Algorithm{Id=1, Name="Alg 1", CreatedBy="user a1", Desc="1 Alg.............end", Activity = _activities.First()},
                                    new Algorithm{Id=2, Name="Alg 2", CreatedBy="user a1", Desc="2 Alg.............end",Activity = _activities.First()},
                                    new Algorithm{Id=3, Name="Alg 3", CreatedBy="user a1", Desc="3 Alg.............end",Activity = _activities.First()},
