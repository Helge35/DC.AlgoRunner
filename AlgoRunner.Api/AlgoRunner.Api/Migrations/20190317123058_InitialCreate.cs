    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserFavoriteProjects_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteProjects_Users_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteProjects_ProjectId",
                table: "UserFavoriteProjects",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteProjects_UserId1",
                table: "UserFavoriteProjects",
                column: "UserId1");
        }
